"""
Given a list of seating pairs and their happiness modifiers, add a neutral "you" and
return the total happiness modification of the optimal seating arrangement
"""
