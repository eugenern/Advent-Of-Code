...
def has_abba(match_obj):
	...
	# use map instead of filter because a value of 0 in a filter object is considered false
	return any(map(lambda x: seq[x] != seq[x + 1] and seq[x + 1] == seq[x + 2] and seq[x] == seq[x + 3], range(len(seq) - 3)))
