...
form the input to solve the problem in clingo syntax
"""
...
def parse(line, prev, writer):
    """
    each line will contain information about which floor its describing
    and what objects are on that floor initially
...
def form_input(reader, writer):
    ...
    # assuming the first floor is always called 'first',
    # the elevator will always start out on 'first'
